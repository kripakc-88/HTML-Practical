# HTML-Practical
Description
This repository contains basic HTML indexs created as part of a web development assignment. The indexs demonstrate fundamental HTML concepts such as page structure, forms, tables, and semantic HTML5 elements.
